		...
		<>
			<Formik
				...
				validationSchema={Yup.object({
					userName: Yup.string().max(20, 'Debe tener un máximo de 15 caracteres.').required('Required'),
					password: Yup.string().max(20, 'Debe tener un máximo de 15 caracteres.').required('Required'),
					firstName: Yup.string().max(30, 'Debe tener un máximo de 20 caracteres.').required('Required'),
					lastName: Yup.string().max(30, 'Debe tener un máximo de 20 caracteres.').required('Required'),
			...
			>
				<Form>
					...
					<div className='row'>
						<MyTextInput label='Nombre' name='firstName' type='text' placeholder='Nombre' disabled={true} />
						<MyTextInput
							label='Apellido'
							name='lastName'
							type='text'
					...
					<div className='row'>
						<MyTextInput
							...
							name='email'
							type='email'
							placeholder='tu_correo@dameuna.pata'
							disabled={true}
						/>
						<MySelect label='Tu Avatar' name='avatar' disabled={true}>
						...
						<MyCheckbox name='donor' disabled={true}>
							Marca si quieres dar mascotas en adopción.
						</MyCheckbox>
					</div>

					<MyCheckbox name='acceptedTerms' disabled={true}>
